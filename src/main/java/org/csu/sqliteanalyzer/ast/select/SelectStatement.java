...
public class SelectStatement extends ASTNode {
    ...
    public SelectStatement(List<Object> selectList, String tableName, String whereClause) {
        this(selectList, tableName, whereClause, null, null);
    }
    ...
    public SelectStatement(
        ...
        this(selectList, tableName, whereClause, null, orderByClause);
    }
    ...
    public String toString() {
        return String.format(
                "SelectStatement{selectList=%s, tableName='%s', whereClause=%s, " +
